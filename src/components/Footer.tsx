  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 md:py-10">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-[minmax(0,1fr)_280px]">
          <div>
            ...
            <p className="max-w-xs text-sm leading-relaxed text-gray-400">
              Dealer resmi Suzuki terpercaya dengan pelayanan terbaik untuk
              kebutuhan mobil Anda dan keluarga.
            </p>
        ...
        <div className="mt-8 border-t border-gray-800 pt-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-500">
          <p>
            © {new Date().getFullYear()} Suzuki Dealer. Semua hak dilindungi.
          </p>
